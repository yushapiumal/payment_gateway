...
<body>
    ...
    <div class="payment-form">
        ...
        <div id="notificationMessage" class="w-full max-w-md p-4 bg-white rounded-lg  hidden">
            ...
            <a href="index.php" class="px-6 py-3 text-white font-semibold bg-gradient-to-r  from-green-500 to-blue-500 rounded-lg shadow-lg hover:from-blue-600 hover:to-purple-600 transform transition duration-300 ease-in-out hover:scale-105">
    Return to Home
</a>
